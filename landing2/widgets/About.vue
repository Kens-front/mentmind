    ...
    <section class="we" ref="section">
        ...
        <div class="text" ref="text">
            <p class="spans">
                ...
                <span>Личные наставники, повышающие Ваши скиллов</span>
              
                <span>Даём комфортные условия для продвинутого обучения</span>

                <span>Создаем персональный маршрут до следующего грейда</span>
            </p>
        </div>
        <div class="mix"></div>
    </section>
